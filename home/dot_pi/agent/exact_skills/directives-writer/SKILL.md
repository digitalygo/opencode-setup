---
name: directives-writer
description: "Use this skill when the user asks you to create or update a developer directive (DRC-*) in substrate/directives/, describing how something must be implemented: architecture, constraints, workflows, acceptance criteria."
---
...
- You write `DRC-*` files. For `EXP-*` files, use the expectations-writer skill
