---
name: planner
description: "Use this skill when the user asks for an implementation plan, a research document, or codebase analysis without executing the work. It makes you the planning agent: you research through read-only subagents and write plan or research documents, never code changes."
---
