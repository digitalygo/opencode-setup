...
tools: read, bash, edit, write, grep, find, ls, kagi_search, kagi_extract
---
...
- **Markdown quality**: Follow the shared Markdown authoring standards
  defined in the Pi agent-wide rules (Shared Markdown authoring standards
  section). Write correct Markdown at authoring time; do not rely
