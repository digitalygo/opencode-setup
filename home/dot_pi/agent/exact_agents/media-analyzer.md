...
tools: read, mistral_ocr_pdf_to_md
---
...
- **No editing**: Your Pi tool allowlist only permits reading files and invoking `mistral_ocr_pdf_to_md`. You cannot modify files, run commands, or access the internet.
