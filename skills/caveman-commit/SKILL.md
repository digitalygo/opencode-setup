---
name: caveman-commit
description: Compressed commit message generator. Reduces noise while preserving intent and reasoning. Conventional Commits format. Subject ≤50 chars, body only when "why" isn't obvious.
---
